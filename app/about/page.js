    ...
    <div className='min-h-screen'>
      ...
      <div>
        ...
        <div className="authors my-16 flex flex-wrap items-center justify-center gap-8">
          <div className='bg-stone-100 hover:bg-white text-black p-5 max-sm:p-3 flex items-center gap-8 max-sm:gap-4 rounded-xl border border-gray-3 w-[25rem] max-sm:flex-col '>
            <div>
